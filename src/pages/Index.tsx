...
const SectionLabel = ({ icon: Icon, text }: { icon: LucideIcon; text: string }) => {
  ...
  return (
    ...
    >
      <div
        className="group flex items-center gap-3 px-6 py-2.5 rounded-full font-nunito font-bold text-xs uppercase tracking-[0.2em]"
        style={{ 
          background: "rgba(255,255,255,0.6)", 
          border: "1px solid rgba(229,127,132,0.15)", 
          color: "#E57F84",
          boxShadow: "0 10px 30px rgba(60,30,30,0.05)",
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{ background: "#F6F2EA" }}>
      ...
      <main className="flex-1 relative z-10">
        ...
        <SectionLabel icon={Sprout} text="Our Story" />
        ...
        <SectionLabel icon={Heart} text="Signature Craft" />
        ...
        <SectionLabel icon={ShoppingBag} text="The Collection" />
        ...
        <SectionLabel icon={Stars} text="Why Handmade" />
        ...
        <SectionLabel icon={GraduationCap} text="Learn to Crochet" />
        ...
        <SectionLabel icon={MessageCircle} text="What People Say" />
        ...
        <SectionLabel icon={Mail} text="Get in Touch" />
